...
const process = [
  {
    ...
    desc: "We start by analyzing your requirements and developing a comprehensive project strategy.",
  },
  {
    id: "02",
    title: "Design & Prototyping",
    desc: "Our designers create user-focused interfaces and interactive prototypes for your approval.",
  },
  {
    id: "03",
  ...
  },
  {
    ...
    desc: "We thoroughly test your solution and deploy it with ongoing monitoring and support.",
  },
];
      ...
      <div className="wrapper">
        ...
        >
          <div className="space-y-3">
            ...
            <h2 className="text1">From Idea to Implementation</h2>
          </div>
          <p className="desc text-white/70">
            Our proven methodology ensures successful project delivery through
            structured phases. From strategic planning and design to development,
            testing, and deployment, we execute each step with precision,
            transparency, and a focus on delivering exceptional results.
          </p>
        </div>
        <div
          data-aos="fade-up"
