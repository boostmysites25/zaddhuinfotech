    ...
    <div className="py-14">
      <div className="wrapper flex flex-col items-center gap-3">
        ...
        <h2 className="text1 text-center max-w-3xl mx-auto">
          Choose Excellence in Technology Solutions
        </h2>
        <p className="desc text-center max-w-3xl mx-auto">
          Learn why leading companies choose us as their technology partner for
          innovative solutions that deliver measurable results and drive business growth.
        </p>
      </div>
