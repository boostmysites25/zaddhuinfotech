...
const Footer = () => {
  return (
    <div className="pt-7">
      <div
        className="bg-cover bg-no-repeat bg-center pt-[5rem] pb-7 space-y-8 relative"
        style={{ backgroundImage: `url(${bgImg})` }}
      >
        <div className="absolute inset-0 w-full h-full bg-primary/15"></div>
        <div className="wrapper space-y-8 relative z-[1]">
          ...
          <p className="text-sm text-center">
            Copyright © {new Date().getFullYear()} Zaddhu InfoTech Pvt. Ltd | All
            Rights Reserved
          </p>
        </div>
      </div>
