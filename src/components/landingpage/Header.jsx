  ...
  return (
    <>
      <div className="fixed top-0 left-0 w-full z-[100]">
        ...
        <div className="bg-white/20 backdrop-blur-sm flex items-center py-5">
          <div className="wrapper w-full h-fit flex items-center justify-between gap-10">
            ...
            >
              <img src={logo} alt="logo" className="w-[7rem] sm:w-[9rem]" />
            </Scroll>
            ...
            <div data-aos="fade-down" className="hidden lg:flex">
              <Scroll
                ...
                duration={500}
                offset={-150}
                className="btn-fullrounded bg-primary text-black hover:bg-black hover:text-white border border-primary"
              >
                Get a Free Quote
              </Scroll>
            </div>
