        ...
        <div className="wrapper absolute w-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[2] flex flex-col-reverse gap-5 sm:grid grid-cols-[1fr,20%] items-center">
          <div data-aos="fade-up" className="max-w-[50rem] space-y-1">
            ...
            <h1 className="text_xl">
              Building Tomorrow's <br /> Digital Solutions <br />
      ...
      <section className="wrapper">
        ...
        >
          ...
          <div className="2xl:absolute right-0 top-1/2 2xl:-translate-y-1/2 p-5 2xl:px-10 2xl:w-2/5">
            ...
            >
              <b className="text-white">TechFlow Solutions</b> specializes in
              creating <b className="text-white">cutting-edge</b>{" "}
              digital experiences that drive business success. From{" "}
              <b className="text-white">web applications</b> to{" "}
              <b className="text-white">mobile solutions</b>, we deliver
              innovative technology that transforms ideas into powerful digital assets.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="pb-14 wrapper space-y-3">
        ...
        <div className="grid md:grid-cols-[40%,1fr] gap-10">
          ...
          <div data-aos="fade-up" className="space-y-3">
            <h2 className="text1">
              Crafting Digital Excellence Through Innovation and Expertise
            </h2>
            <p className="desc text-white/70">
              At TechFlow Solutions, we are passionate about creating digital
              experiences that make a difference. Our team combines technical
              expertise with creative vision to deliver web applications, mobile
              apps, and AI solutions that drive real business results. We believe
              in building partnerships that last, providing ongoing support and
              innovation to help our clients stay ahead in the competitive
              digital landscape. From concept to deployment, we're committed to
            ...
            <div className="grid sm:grid-cols-2 gap-3 py-6">
              <div className="bg-[#121212] flex items-center gap-3 justify-center rounded p-3">
                <div className="bg-black rounded-full w-14 min-w-14 h-14 flex items-center justify-center">
                  <PiStrategyBold size={30} className="fill-primary" />
                </div>
                <p className="text3">Innovation-Driven Development</p>
              </div>
              <div className="bg-[#121212] flex items-center gap-3 justify-center rounded p-3">
                <div className="bg-black rounded-full w-14 min-w-14 h-14 flex items-center justify-center">
                  <MdSecurity size={30} className="fill-primary" />
                </div>
            ...
            <div className="space-y-3">
              <div className="flex gap-2">
                <div className="w-4 h-4 min-w-4 bg-primary rounded-full mt-[.30rem]" />
                <p className="desc">
